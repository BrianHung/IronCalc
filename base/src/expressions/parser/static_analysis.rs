...
fn static_analysis_on_function(kind: &Function, args: &[Node]) -> StaticResult {
    match kind {
        ...
        Function::BetaDist => scalar_arguments(args),
        Function::BetaInv => scalar_arguments(args),
        Function::BinomDist => scalar_arguments(args),
        Function::BinomDistRange => scalar_arguments(args),
        Function::BinomInv => scalar_arguments(args),
        Function::ExponDist => scalar_arguments(args),
        Function::Gamma => scalar_arguments(args),
        Function::GammaDist => scalar_arguments(args),
        Function::GammaInv => scalar_arguments(args),
        Function::Gammaln => scalar_arguments(args),
        Function::GammalnPrecise => scalar_arguments(args),
        Function::PoissonDist => scalar_arguments(args),
        Function::WeibullDist => scalar_arguments(args),
