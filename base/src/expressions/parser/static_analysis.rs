...
fn get_function_args_signature(kind: &Function, arg_count: usize) -> Vec<Signature> {
    match kind {
        ...
        Function::PercentrankExc => vec![Signature::Vector, Signature::Scalar, Signature::Scalar],
        Function::PercentrankInc => vec![Signature::Vector, Signature::Scalar, Signature::Scalar],
