...
impl Function {
    pub fn into_iter() -> IntoIter<Function, 211> {
        [
            Function::And,
            Function::False,
            Function::If,
...
impl Function {
    ...
    pub fn get_function(name: &str) -> Option<Function> {
        match name.to_ascii_uppercase().as_str() {
            ...
            "BETA.DIST" => Some(Function::BetaDist),
            "BETA.INV" => Some(Function::BetaInv),
            ...
            "GAMMA" => Some(Function::Gamma),
            "GAMMA.DIST" => Some(Function::GammaDist),
            "GAMMA.INV" => Some(Function::GammaInv),
            "GAMMALN" => Some(Function::Gammaln),
            "GAMMALN.PRECISE" => Some(Function::GammalnPrecise),
...
impl Model {
    ...
    pub(crate) fn evaluate_function(
        ...
        match kind {
            ...
            Function::Gammaln => self.fn_gammaln(args, cell),
            Function::GammalnPrecise => self.fn_gammaln_precise(args, cell),
